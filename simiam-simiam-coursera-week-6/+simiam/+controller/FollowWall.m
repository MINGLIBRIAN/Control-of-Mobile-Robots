...
%             obj.p = simiam.util.Plotter();
        ...
        function outputs = execute(obj, robot, state_estimate, inputs, dt)
            ...
            if(strcmp(inputs.direction,'right'))
				...
				[a,b] = sort(ir_distances(5:-1:3));
				b = sort(b(1:2));
                p_1 = ir_distances_wf(:,6-b(1));
                p_2 = ir_distances_wf(:,6-b(2));
            else
                % Pick two of the left sensors based on ir_distances
				[a,b] = sort(ir_distances(1:3));
				b = sort(b(1:2));
                p_1 = ir_distances_wf(:,b(1));
                p_2 = ir_distances_wf(:,b(2));
            end
			...
			alpha = 0.25;
            u_fw = alpha*u_fw_tp+(1-alpha)*u_fw_pp;
