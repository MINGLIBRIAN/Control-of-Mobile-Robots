    ...
    %% METHODS
        ...
        %   See also controller/execute
            ...
            if (obj.check_event('at_goal'))
                ...
                if obj.check_event('at_obstacle') && ~obj.check_event('unsafe') && ~obj.is_in_state('follow_wall')
                ...
                if obj.is_in_state('follow_wall') && obj.check_event('progress_made') && ~obj.check_event('unsafe') && ~obj.check_event('at_obstacle')
					set_progress_point(obj);
...
%                 fprintf('now sliding right\n');
        ...
        function rc = progress_made(obj, state, robot)
            ...
            if obj.d_prog - 0.1 > norm([x-obj.goal(1);y-obj.goal(2)])
                rc = true;
            end
